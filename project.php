...
<body>
    ...
    <form class="form1" method="post" enctype="multipart/form-data">
        <p class="upload">UPLOAD YOUR FILE</p>
        <input type="file" name="myfile" />
        <input type="text" name="category" placeholder="Department" required/>
    ...
    <form class="form2" method="post">
        <label class="searchtext">SEARCH YOUR FILE</label>
        <br/>
...
<div class="project">
    <p class="records">Project name:</p>
...
<div class="section1">
    <div class="section2">
    <p class="records">List of Files:</p>
    <ol class="categories">
        <?php
        $color=isset($_GET['color'])?$_GET['color'] : "";
    ...
    <div class="section3">
    <table class="list">
    <tr><th>Department</th><th>File Name</th><th>Operation</th></tr>
    <?php
